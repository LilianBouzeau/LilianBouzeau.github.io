...
const translations = {
  FR: {
    ...
    paragrapheCgu1: "Bienvenue sur Cruchaudet...",
    TitreCgu2: "1. Propriété du site",
    paragrapheCgu2: "Le contenu, la structure...",
    TitreCgu3: "2. Utilisation du site",
    paragrapheCgu3: "Vous vous engagez à utiliser...",
    TitreCgu4: "3. Responsabilité",
    paragrapheCgu4: "Cruchaudet met tout en œuvre...",
    TitreCgu5: "4. Données personnelles",
    paragrapheCgu5: "Aucune donnée personnelle...",
    TitreCgu6: "5. Modifications des CGU",
    paragrapheCgu6: "Cruchaudet se réserve le droit...",
    TitreCgu7: "6. Contact",
  ...
  EN: {
    ...
    paragrapheCgu1: "Welcome to Cruchaudet...",
    TitreCgu2: "1. Site Ownership",
    paragrapheCgu2: "The content, structure...",
    TitreCgu3: "2. Use of the site",
    paragrapheCgu3: "You agree to use this site only for lawful purposes...",
    TitreCgu4: "3. Liability",
    paragrapheCgu4: "Cruchaudet makes every effort...",
    TitreCgu5: "4. Personal Data",
    paragrapheCgu5: "No personal data is collected...",
    TitreCgu6: "5. CGU Modifications",
    paragrapheCgu6: "Cruchaudet reserves the right...",
    TitreCgu7: "6. Contact",
  ...
  ES: {
    ...
    paragrapheCgu1: "Bienvenido a Cruchaudet...",
    TitreCgu2: "1. Propiedad del sitio",
    paragrapheCgu2: "El contenido, la estructura...",
    TitreCgu3: "2. Uso del sitio",
    paragrapheCgu3: "Te comprometes a usar este sitio solo con fines legales...",
    TitreCgu4: "3. Responsabilidad",
    paragrapheCgu4: "Cruchaudet hace todo lo posible...",
    TitreCgu5: "4. Datos personales",
    paragrapheCgu5: "No se recopilan datos personales...",
    TitreCgu6: "5. Modificaciones de las CGU",
    paragrapheCgu6: "Cruchaudet se reserva el derecho...",
  ...
  IT: {
    ...
    paragrapheCgu1: "Benvenuto su Cruchaudet...",
    TitreCgu2: "1. Proprietà del sito",
    paragrapheCgu2: "Il contenuto, la struttura...",
    TitreCgu3: "2. Uso del sito",
    paragrapheCgu3: "Ti impegni a utilizzare il sito solo per scopi leciti...",
    TitreCgu4: "3. Responsabilità",
    paragrapheCgu4: "Cruchaudet fa tutto il possibile...",
    TitreCgu5: "4. Dati personali",
    paragrapheCgu5: "Nessun dato personale viene raccolto...",
    TitreCgu6: "5. Modifiche alle CGU",
    paragrapheCgu6: "Cruchaudet si riserva il diritto...",
